...
<body>
    <div class="container">
        ...
        <div class="col-md-12 search-table-col" style="margin-top: 20px;">
            ...
            <a href="{{ url('register') }}"><button class="btn btn-outline-primary text-truncate float-none float-sm-none add-another-btn" data-bss-hover-animate="pulse" type="button">Add Student<i class="fas fa-plus-circle edit-icon"></i></button></a>
